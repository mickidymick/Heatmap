...
int main(int argc, char* argv[]) {
    ...
    tmp = G.get_log2_size(G.total_address_space);
    cout << RESET << "Total_addr_size: " << GREEN << tmp.first << MAGENTA << tmp.second
       << GREEN << "   " << G.total_address_space << MAGENTA << " Bytes" << endl;	
		cout << endl;
		...
		cout << RESET << fixed << "Total_timespan: " << GREEN << G.timespan 
			 << MAGENTA << " Seconds" << endl;
		cout << RESET << fixed << "Time between heatmapings: " << GREEN << G.interval 
			 << MAGENTA << " Seconds" << endl;
		cout << RESET << fixed << "Number of heatmapings to perform: " << GREEN 
			 << G.num_itter << endl;
		cout << RESET << "Final First_addr: " << GREEN << G.first_address << endl;	
		cout << RESET << "Final Last_addr: " << GREEN << G.f_last_address << endl;	
    tmp = G.get_log2_size(G.rounded_total_address_space);
		cout << RESET << "Rounded total_addr_size: " << GREEN << tmp.first << MAGENTA 
      << tmp.second << "   " << GREEN << G.rounded_total_address_space << MAGENTA 
      << " Bytes" << endl;	
		cout << endl;

		cout << CYAN << "CACHE PARAMS" << endl;
    tmp = G.get_log2_size(G.cache_size);
		cout << RESET << "Size of cache: " << GREEN << tmp.first << MAGENTA << tmp.second 
       << GREEN << "   " << G.cache_size << MAGENTA << " Bytes" << endl;
		cout << RESET << "Size of each counter: " << GREEN << G.counter_size 
			 << MAGENTA << " Bits" << endl;
		cout << RESET << "Number of regions in cache: " << GREEN 
			 << G.num_cache_regions << endl;
		cout << endl;
